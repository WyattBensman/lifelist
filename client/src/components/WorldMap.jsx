export default function WorldMap() {
  return (
    <div className="bg-[#346664] flex flex-col md:flex-row">
      {/* Content */}
      <div className="md:w-1/2 w-11/12 mt-24 ml-[12.5%]">
        <h2 className="text-5xl font-bold text-[#34CC98] w-1/2">World Map</h2>
      ...
      {/* Mockup */}
      <div className="w-full md:w-1/2 flex justify-center mt-5 mb-10 mr-[5%]">
